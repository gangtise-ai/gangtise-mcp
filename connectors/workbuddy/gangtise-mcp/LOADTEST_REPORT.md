...
![QPS](loadtest/out/qps.png)

### 延迟分布（P50 / P99 时序）

![Latency](loadtest/out/latency.png)

### 延迟直方图

![Latency hist](loadtest/out/latency_hist.png)

### 错误率曲线

![Error rate](loadtest/out/error_rate.png)

### 资源占用（压测客户端）

![Resource](loadtest/out/resource.png)
...
- 原始样本：`loadtest/out/metrics.jsonl`（体积较大，默认不入库）；机器可读汇总：`loadtest/out/summary.json`。
- 复现：见 `loadtest/README.md`。
