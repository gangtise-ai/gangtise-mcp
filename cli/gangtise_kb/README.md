...
```bash
uvx --with "git+https://github.com/gangtise-ai/gangtise-mcp#subdirectory=mcp/gangtise_kb" \
  --from "git+https://github.com/gangtise-ai/gangtise-mcp#subdirectory=cli/gangtise_kb" \
  gangtise-kb list
```
