...
```bash
uvx --with "git+https://github.com/gangtise-ai/gangtise-mcp#subdirectory=mcp/gangtise_file" \
  --from "git+https://github.com/gangtise-ai/gangtise-mcp#subdirectory=cli/gangtise_file" \
  gangtise-file list
```
